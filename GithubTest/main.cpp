...
namespace {
    ...
    constexpr auto DRAW_TEXT2 = _T("testtesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttest");
...
int CALLBACK WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nCmdShow) {
    ...
    while (ProcessMessage() != -1) {
        ...
        DrawString(10, 705, DRAW_TEXT2, textColor);
